 ...
 * @returns {any}
 */
export function openBytes(filename, bytes) {
 ...
 * @returns {any}
 */
export function openWithSidecars(filename, bytes, sidecars) {
    const ptr0 = passStringToWasm0(filename, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function probeBytes(filename, bytes) {
    const ptr0 = passStringToWasm0(filename, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {number}
 */
export function recommended_chunk_size_mb() {
 ...
 * @returns {any}
 */
export function sidecarRequirements(filename, bytes) {
    const ptr0 = passStringToWasm0(filename, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nirs4all_formats_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
