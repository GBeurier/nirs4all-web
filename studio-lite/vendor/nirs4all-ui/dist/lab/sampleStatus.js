...
export function isSampleStatus(value) {
    return typeof value === 'string'
        && Object.prototype.hasOwnProperty.call(SAMPLE_STATUS_DISPLAY, value);
}
export function resolveSampleStatus(value, fallback = 'received') {
    return isSampleStatus(value) ? value : fallback;
}
export function getSampleStatusDisplay(value) {
...
export function countSampleStatuses(statuses) {
    const counts = {
        received: 0,
        nirs_measured: 0,
        to_remeasure: 0,
...
//# sourceMappingURL=sampleStatus.js.map