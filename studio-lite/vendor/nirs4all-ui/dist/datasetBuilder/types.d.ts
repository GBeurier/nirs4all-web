...
export type DatasetRole = "x" | "y" | "metadata" | "id" | "partition" | "replicate" | "group" | "ignored";
/** The kind of signal a source carries — drives the config-panel options. */
export type SignalType = "spectra" | "table" | "image" | "timeseries" | "hyperspectral" | "metadata" | "target" | "other";
...
export type SemanticType = "regression" | "classification" | "wavelength" | "identifier" | "temporal" | "categorical";
/** How a whole source is consumed by the dataset. */
export type SourceUseAs = "x_train" | "x_test" | "x_train_test" | "y_train" | "y_test" | "metadata" | "metadata_train_test" | "join_table" | "partition" | "auxiliary";
...
export type TargetTask = "auto" | "regression" | "classification" | "multilabel" | "multiclass" | "ordinal";
...
export declare const DEFAULT_ADVANCED_OPTIONS: AdvancedOptions;
