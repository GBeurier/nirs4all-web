 ...
 */
export function isBetterScore(a, b, metric) {
...
export function formatMetricValue(value, metric) {
    ...
    if (!Number.isFinite(num))
        return "-";
    if (metric && isLowerBetter(metric))
...
export function formatMetricDisplayName(metric) {
...
//# sourceMappingURL=scoreValues.js.map