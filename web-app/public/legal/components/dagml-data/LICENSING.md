# Licensing — dag-ml-data

`dag-ml-data` is part of the **nirs4all ecosystem** and is offered under a
...
`dag-ml-data` relies on third-party open-source components. Their licenses are summarized
