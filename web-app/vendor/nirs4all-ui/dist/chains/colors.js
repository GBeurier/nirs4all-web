 ...
 */
const CHAIN_DIVERGING_STOPS = ["#0f766e", "#ece9e2", "#c2620e"];
export const CHAIN_ROLE_COLORS = {
 ...
 */
export function effectColor(value, baseline, halfRange) {
...
export function effectTextColor(value, baseline, halfRange) {
    if (!Number.isFinite(value))
        return "var(--n4-color-muted, #64748b)";
    const span = halfRange > 0 ? halfRange : 1;
