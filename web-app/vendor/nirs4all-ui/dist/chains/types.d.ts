...
export type ChainStepRole = "split" | "preprocess" | "feature" | "model" | "augmentation" | "target" | "other";
...
export declare const CHAIN_ROLE_LABELS: Readonly<Record<ChainStepRole, string>>;
/** Stable display order for roles (used when listing/grouping). */
export declare const CHAIN_ROLE_ORDER: readonly ChainStepRole[];
/** Roles whose *order* is meaningful — the "transform stack" of a chain. */
export declare const CHAIN_TRANSFORM_ROLES: readonly ChainStepRole[];
/** Short labels for each normalization lens. */
export declare const CHAIN_LENS_LABELS: Readonly<Record<ScoreLens, string>>;
/** Coerce an arbitrary role string to a known {@link ChainStepRole}. */
export declare function coerceChainRole(role: string | undefined): ChainStepRole;
