...
const METRIC_ALIAS_KEYS_BY_CANONICAL = new Map();
...
export function normalizeMetricLookupKey(key) {
 ...
 */
export function metricKeyCandidates(key) {
    const normalized = normalizeMetricLookupKey(key);
...
//# sourceMappingURL=metricKeys.js.map