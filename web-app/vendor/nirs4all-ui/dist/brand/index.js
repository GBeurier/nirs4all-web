...
function brand(id, name, role, accent, tags) {
...
const BRAND_ID_SET = new Set(NIRS4ALL_BRANDS.map((definition) => definition.id));
...
export function getNirs4allBrandRasterPath(brand, raster) {
    const id = typeof brand === "string" ? brand : brand.id;
