...
export const validatedmethodsarchivev2_bind_inspected_native_predictor_v1: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: bigint, i: number, j: number, k: number, l: bigint, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number, w: number, x: number, y: number, z: bigint, a1: number, b1: number, c1: number, d1: number, e1: number, f1: number) => [number, number, number, number];
export const validatedmethodsarchivev2_binding_id: (a: number) => [number, number];
export const validatedmethodsarchivev2_format_version: (a: number) => number;
export const validatedmethodsarchivev2_model_bytes: (a: number) => [number, number];
export const validatedmethodsarchivev2_new: (a: number, b: number) => [number, number, number];
export const validatedmethodsarchivev2_node_id: (a: number) => [number, number];
