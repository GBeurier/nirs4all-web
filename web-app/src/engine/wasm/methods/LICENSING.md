# Licensing — nirs4all-methods

`nirs4all-methods` is part of the **nirs4all ecosystem** and is offered under a
...
for example, embedding `nirs4all-methods` in a **proprietary, closed-source product or SaaS**
...
`nirs4all-methods` relies on third-party open-source components. Their licenses are summarized
