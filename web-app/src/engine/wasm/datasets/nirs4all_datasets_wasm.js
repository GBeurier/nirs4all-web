/* @ts-self-types="./nirs4all_datasets_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function resolve(index_json, dataset_id) {
    let deferred4_0;
    let deferred4_1;
    try {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./nirs4all_datasets_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nirs4all_datasets_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
