# Licensing — nirs4all-io

`nirs4all-io` is part of the **nirs4all ecosystem** and is offered under a
...
for example, embedding `nirs4all-io` in a **proprietary, closed-source product or SaaS**
...
`nirs4all-io` relies on third-party open-source components. Their licenses are summarized
